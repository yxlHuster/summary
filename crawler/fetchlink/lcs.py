...
if __name__ == '__main__':
  lcs = find_lcs("http://bbs.wdzj.com/forum-2-2.html", "http://bbs.wdzj.com/forum-2-3.html")
  print lcs

  template = []
  for i, x in enumerate("http://bbs.wdzj.com/forum-2-2.html"):
    if lcs[i] == x:
      template.append(x)
      continue
    break
  template.append("%d")
  template.append(lcs[i:])
